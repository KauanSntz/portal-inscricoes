...
(() => {
  const coursesData = {
    ...
    sul: { presencial: [], hibrido: [], semipresencial: [], ead: [] },
    norte: { presencial: [], hibrido: [], semipresencial: [], ead: [] },
    oeste: { presencial: [], hibrido: [], semipresencial: [], ead: [] }
  };

  // Disponível globalmente pro app.js
