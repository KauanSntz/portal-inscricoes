...
(() => {
  ...
  window.coursesData = {
    ...
    sul:   { presencial: [], hibrido: [], semipresencial: [], ead: EAD_COMUM },
    norte: { presencial: [], hibrido: [], semipresencial: [], ead: EAD_COMUM },
    oeste: { presencial: [], hibrido: [], semipresencial: [], ead: EAD_COMUM }
  };
})();
